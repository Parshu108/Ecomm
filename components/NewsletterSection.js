  ...
  return (
    <section className="relative bg-black py-24 px-6 border-t border-[#0A2647] overflow-hidden">
      ...
      <div className="relative max-w-2xl mx-auto text-center">
        {/* Eyebrow */}
        <span className="inline-flex items-center gap-2 font-mono bg-[#001B38] border border-[#0A2647] text-[#95D7DE] text-xs font-medium tracking-[0.2em] uppercase px-4 py-1.5 rounded-full mb-6">
          <span className="w-1.5 h-1.5 rounded-full bg-[#95D7DE] animate-pulse" />
          Newsletter
        </span>

        {/* Headline */}
        <h2 className="text-4xl sm:text-5xl font-bold text-[#EAF6F8] leading-tight mb-4 tracking-tight">
