...
export default function AdminProductsPage() {
  ...
  return (
    <div className="space-y-6 bg-background">
      ...
      {/* Filters & Search */}
      <div className="flex flex-col sm:flex-row items-center gap-4 bg-card p-4 rounded-2xl shadow-sm border border-border">
        <div className="relative flex-1 w-full">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-background border border-input rounded-xl text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring"
          />
        </div>
        ...
        <select
          ...
          className="w-full sm:w-48 px-3.5 py-2.5 bg-background border border-input rounded-xl text-sm font-medium text-foreground focus:outline-none focus:ring-2 focus:ring-ring capitalize"
        >
                    ...
                    return (
                      ...
                      >
                        <td className="py-4 px-6">
                          <div className="flex items-center gap-3">
                            <Image
                              ...
                              width={48}
                              height={48}
                              className="w-12 h-12 rounded-xl object-cover bg-secondary/60 border border-border"
                            />
                            <div>
                        ...
                        <td className="py-4 px-6 capitalize">
                          <span className="bg-secondary text-muted-foreground px-2.5 py-1 rounded-md text-xs font-semibold">
                            {p.category || "general"}
                          </span>
                        </td>
                        ...
                        <td className="py-4 px-6">
                          {isLowStock ? (
                            ...
                            <span className="inline-flex items-center gap-1.5 bg-emerald-500/10 text-emerald-400 px-2.5 py-1 rounded-full text-xs font-bold">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 bg-background border border-input rounded-xl text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2 bg-background border border-input rounded-xl text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-ring"
                  />
                </div>
                <div>
                  <label className="block text-xs font-bold uppercase text-muted-foreground mb-1">
              ...
              <div>
                ...
                <div className="mt-2 flex items-center gap-3">
                  <label className="cursor-pointer bg-secondary hover:bg-secondary/80 text-secondary-foreground px-3 py-1.5 rounded-lg text-xs font-bold inline-flex items-center gap-1.5 transition">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-border">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="px-4 py-2 bg-secondary hover:bg-secondary/80 text-secondary-foreground rounded-xl text-sm font-semibold transition"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="px-5 py-2 bg-primary hover:opacity-90 text-primary-foreground rounded-xl text-sm font-semibold shadow-md shadow-primary/20 transition"
                >
